...
class Advent6Test : FreeSpec({
    "counts how many questions to which anyone said yes" {
        Advent6().distinct("a\nb") shouldBe 2
        Advent6().distinct("a\nab") shouldBe 2
    }
    "counts the sum of distinct yesses per group" {
        advent6("""
            abc
            ...
            b
        """.trimIndent()) shouldBe 11
    }
    "counts yesses for the puzzle input" {
        advent6(puzzle6) shouldBe 7283
    }

    "counts how many questions to which everyone said yes" {
        Advent6().intersection("a\nb") shouldBe 0
        Advent6().intersection("a\nab") shouldBe 1
    }
    "counts all yesses for the puzzle input" {
        advent6b(puzzle6) shouldBe 3520
    }
})
