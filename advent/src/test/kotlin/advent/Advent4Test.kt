...
class Advent4Test : FreeSpec({
    "part one" - {
        "counts valid passports with the sample input" {
            advent4(
                """
        ...
        "counts valid passports with the puzzle input" {
            advent4(puzzle4) shouldBe 247
        }
    }

    "part two" - {
        "checks invalid passports" {
            advent4b(
                """
            eyr:1972 cid:100
